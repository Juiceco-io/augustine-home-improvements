...
const FEATURE_TOGGLES: FeatureToggle[] = [
  {
    ...
    description: "Show the 'Veteran-Owned & TrexPro Certified' badge in the hero section.",
  },
  {
    key: "showTrexProBadge",
    label: "TrexPro Badge",
    description: "Show the TrexPro Certified badge and callout in 'Why Choose Us'.",
  },
  {
    key: "heroEnabled",
    label: "Hero Section",
    description: "Show the full hero section on the home page. Disable to show a minimal header instead.",
  },
];
